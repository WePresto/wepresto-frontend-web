...
export default function LoanSimulator() {
  ...
  return (
    <Flex
      ...
      alignItems="center"
    >
      <Image src="/logo.png" w="200px" alt="logo a color de WePresto" mb={6} />
      ...
      {simulatedLoan ? (
            ...
            <Flex flexDirection={["column", "column", "row"]}>
              ...
              >
                ...
                <Text color="primary.900" fontSize={42} fontWeight="800">
                  {formatCurrency(simulatedLoan.loanInstallments[0].amount)}
                </Text>
              </Flex>
            </Flex>
            <Flex
        ...
        <>
          ...
          <Button
            ...
            spinner={loading ? <Spinner /> : <Text>Simular préstamo</Text>}
            colorScheme={"primary"}
            alignSelf={"flex-end"}
            mt={[14, 14, 20]}
            mr={[0, 0, 4]}
